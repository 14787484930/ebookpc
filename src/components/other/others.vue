<template>
  <div>
      ...
      <el-col :span="24">
        ...
        <el-form :inline="true"  class="demo-form-inline" style="text-align:left">
          <el-form-item label="其他名称">
            <el-input  placeholder="图书名称" v-model="form.otherName"></el-input>
          </el-form-item>
    ...
    <el-row :gutter="24" class="tac">
      <template>
        <el-table :data="list" style="width: 100%">
          ...
          <el-table-column label="其他名称" width="180">
            <template slot-scope="scope">
              <span style="margin-left: 5px">{{ scope.row.otherName }}</span>
            </template>
          </el-table-column>
    ...
    <el-dialog title="其他详情" :visible.sync="dialogFormVisible" style="float: left">
      ...
      <el-row :gutter="24" style="margin-top: 30px">
        <el-col :span="8" :offset="4"><div>其他名称</div></el-col>
        <el-col :span="11"><div style="float: left">{{otherInfo.otherName}}</div></el-col>
      </el-row>

      <el-row :gutter="24">
        <el-col :span="8" :offset="4"><div>是否有发票</div></el-col>
        <el-col :span="11"><div style="float: left">{{hasInvoice(otherInfo.hasInvoice)}}</div></el-col>
      </el-row>

      <el-row :gutter="24">
        <el-col :span="8" :offset="4"><div>原价</div></el-col>
        <el-col :span="11"><div style="float: left">{{otherInfo.originalPrice}}</div></el-col>
      </el-row>
      <el-row :gutter="24">
        <el-col :span="8" :offset="4"><div>现价</div></el-col>
        <el-col :span="11"><div style="float: left">{{otherInfo.presentPrice}}</div></el-col>
      </el-row>

      <el-row :gutter="24">
        <el-col :span="8" :offset="4"><div>发布日期</div></el-col>
        <el-col :span="11"><div style="float: left">{{toDate(otherInfo.createTime , 'yyyy-MM-dd HH:mm',false)}}</div></el-col>
      </el-row>

      <el-row :gutter="24">
        <el-col :span="8" :offset="4"><div>购买日期</div></el-col>
        <el-col :span="11"><div style="float: left">{{toDate(otherInfo.buyDate , 'yyyy-MM-dd HH:mm',false)}}</div></el-col>
      </el-row>

      <el-row :gutter="24">
        <el-col :span="8" :offset="4"><div>微信</div></el-col>
        <el-col :span="11"><div style="float: left">{{otherInfo.weiXin}}</div></el-col>
      </el-row>

      <el-row :gutter="24">
        <el-col :span="8" :offset="4"><div>联系电电话</div></el-col>
        <el-col :span="11"><div style="float: left">{{otherInfo.phone}}</div></el-col>
      </el-row>

      <el-row :gutter="24">
        <el-col :span="8" :offset="4"><div>浏览次数</div></el-col>
        <el-col :span="11"><div style="float: left">{{otherInfo.viewTimes}}</div></el-col>
      </el-row>
...
<script>
  ...
  export default {
    ...
    computed:{
      ...mapGetters({
        list:'others',
        totalPages_other:'totalPages_other'
      })
      /* ...mapState([
         "page"
       ])*/
    ...
    methods: {
      ...
      handleDelete(row) {
        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
          ...
          console.log(data);
          axios.post(baseConfig.BaseUrl.url + 'other/delete',qs.stringify(data)).then(resp => {
            //进项数据刷新
            this.$store.dispatch('getothers');
            //提示消息
            this.$message({
